...
## <div align="center">App Technique😀</div>
   - 생활패턴 및 식품섭취조사 데이터 기반 유병 확률 예측 서비스
   - YOLOv5를 활용한 음식 탐지 및 유병 확률 기반 식단 평가 서비스
   - AI를 이용한 서비스의 시각화 및 텍스트화로 사용자에게 정보 전달 등 

## <div align="center">Why 생생건강통😆</div>
